...
class FireStoreScreen extends StatelessWidget {
                ...
                child: ListTile(
                  onTap: () {
                    if (viewModel.isSelecting.value) {
                      ...
                      // Handle regular tap action (if needed)
                    }
                  },
                  ...
                  trailing: Obx(() => viewModel.isSelecting.value
                      ? Checkbox(
                    activeColor: Color(0xFF075E59),
  ...
  Future<void> showMyDialog(BuildContext context, Task task) async {
    ...
    final focusNodeDateTime = FocusNode();
                ...
                children: [
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      onFieldSubmitted: (_) {
                        Utils.fieldFocusChange(context, focusNodeName, focusNodeDescription);
                      },
                    ),
                  ),
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      onFieldSubmitted: (_) {
                        Utils.fieldFocusChange(context, focusNodeDescription, focusNodeDateTime);
                      },
                    ),
                  ),
                  Container(
